...
# met meer of minder tegels loopt ie uiteindelijk scheef
...
###############item 3
        ...
        text('Item 3', 655, 355)
        text('Price = 250', 655, 375)
        text('max = 1', 655, 395)
############item 4
        image(img, 850, 340, 100, 100)
        text('Item 4', 855, 355)
        text('Price = 500', 855, 375)
        text('max = 1', 855, 395)
############item 5
        image(img, 650, 480, 100, 100)
        text('Item 5', 655, 495)
        text('Price = 400', 655, 515)
        text('max = 1', 655, 535)
##############item 6
        image(img, 850, 480, 100, 100)
        text('Item 6', 855, 495)
        text('Price = 400', 855, 515)
        text('max = 1', 855, 535)
##############item 7
        image(img, 650, 620, 100, 100)
        text('Item 7', 655, 635)
        text('Price = 400', 655, 655)
        text('max = 1', 655, 675)
##############item 8
        image(img, 850, 620, 100, 100)
        text('Item 8', 855, 635)
        text('Price = 600', 855, 655)
        text('max = 1', 855, 675)
...
def keyPressed():
    ...
    # deze keybindings zijn nog van speelbord010. ze zijn oud. ik zal wat nieuws maken 
    # global posxp1, posyp1, posxp2,posyp2
    # if key == 'w':
    #     posyp1 -= stapje
    # if key == 'd':
    #     posxp1 += stapje
    ...
    if screen == 3 and mouseOnItem1() == True:
        if player == 1:
            ...
            if inventoryDict2['item1'] > 0: 
                ...
                movePlayer(1,player2)
                
        elif player == 3:
            if inventoryDict3['item1'] > 0: 
                inventoryDict3['item1'] -= 1
                
                movePlayer(1,player3)
                
        elif player == 4:
            if inventoryDict4['item1'] > 0: 
                inventoryDict4['item1'] -= 1
                
                movePlayer(1,player4)
                
        elif player == 5:
            if inventoryDict5['item1'] > 0: 
                inventoryDict5['item1'] -= 1
                
                movePlayer(1,player5)
                
        elif player == 6:
            if inventoryDict6['item1'] > 0: 
                inventoryDict6['item1'] -= 1
                
                movePlayer(1,player6)
